			...
			<div class="card">
				...
				<div class="card-body">
						...
						<!-- <div class="row">
							<div class="col-md-4">
								<div class="form-group">
									...
									<input name="kode" type="text" class="form-control" id="kode" value="MP-<?= time(); ?>" readonly>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<select name="praktikum" class="form-control">
										...
										foreach ($mapel as $g) {
											echo "<option value='$g[id_praktikum]'>[ $g[kode_praktikum] ] $g[praktikum]</option>";
										}
										?>
					...
					if (isset($_POST['save'])) {
						...
						$insert = mysqli_query($con, "INSERT INTO tb_mengajar VALUES (NULL,'$asisten','$praktikum','$hari','$shift') ");
