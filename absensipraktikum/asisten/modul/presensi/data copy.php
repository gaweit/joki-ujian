                            ...
                            <table id="example" class="display table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    $praktikum = mysqli_query($con, "SELECT * FROM tb_kegiatan
                            					 INNER JOIN tb_asisten ON tb_kegiatan.id_asisten=tb_asisten.id_asisten
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $d['shift'] ?></td>
                                            <td>
                                                <a class="btn btn-info btn-sm" href="?page=presensi&act=scan&id=<?= $d['id_mengajar'] ?>"><i class="fas fa-camera"></i></a>
                                                </a>
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form action="" method="post">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label">ID Praktikum</label>
                            <input type="text" name="praktikum" class="form-control-plaintext" readonly value="<?= $data['id_praktikum'] ?>">
                            <input type="text" name="asisten" class="form-control-plaintext" readonly value="<?= $data['id_asisten'] ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select name="shift" class="form-control">
                                ...
                                <option value='1'>Shift 3</option>;
                                <option value='1'>Shift 4</option>;
                ...
                if (isset($_POST['savepraktikum'])) {
                    $save = mysqli_query($con, "INSERT INTO tb_kegiatan VALUES(NULL,'$_POST[asisten]','$_POST[praktikum]','$_POST[modul],'$_POST[shift]','$_POST[hari]')");
                    if ($save) {
                        echo "
