...
foreach ($qry as $db)
	...
	$walikelas = mysqli_query($con, "SELECT * FROM tb_walikelas INNER JOIN tb_asisten ON tb_walikelas.id_asisten=tb_asisten.id_asisten WHERE tb_walikelas.id_mkelas='$d[id_mkelas]' ");
