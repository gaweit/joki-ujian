				...
				<div class="tab-pane fade" id="pills-profile-nobd" role="tabpanel" aria-labelledby="pills-profile-tab-nobd">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<button name="updateProfile" type="submit" class="btn btn-danger btn-block">Simpan</button>
						</div>
...
<a href="javascript:history.back()" class="btn btn-default wrap-login100" style=" margin-left: 15px"><i class="fas fa-arrow-circle-left"></i> Kembali</a>