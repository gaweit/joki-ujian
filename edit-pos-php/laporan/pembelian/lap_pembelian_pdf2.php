...
';
    ...
    $content .= '
<page><br>
	<a style="text-decoration: none; font-size:16px; color: black; margin-left:325px; "> Toko Jajan RIa </a><br>
    ...
    <table border="1px" class="tabel" align="center">
    		...
    		<tr>
				...
				$sql = $koneksi->query("select * from tb_pembelian2, tb_barang2 where tb_pembelian2.kode_barang=tb_barang2.kode_barang and  tanggal between '$tgl1' and '$tgl2'");
