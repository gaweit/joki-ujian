...
<page><br>
    ...
    <table border="1px" class="tabel" align="center">
    		...
    		<tr>
				...
				$sql = $koneksi->query("select * from tb_retur, tb_barang2 where tb_retur.kode_barang=tb_barang2.kode_barang and  tgl_retur between '$tgl1' and '$tgl2'");
    		...
    		$content .='
    			...
    			<tr>
                    <th style="text-align: center; font-size: 17px;" colspan="6">Total Pengembalian </th>
