                        ...
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                <thead>
                                 ...
                                 <?php
                                    $no=1;
                                    $sql = $koneksi->query("select * from tb_pembelian2, tb_barang2 where tb_pembelian2.kode_barang=tb_barang2.kode_barang ");
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                         ...
                         <form role="form" method="POST" action="laporan/pembelian/lap_pembelian_pdf2.php" target="blank" >
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="./laporan/pembelian/lap_pembelian_pdf.php" class="btn btn-primary waves-effect" target="blank" style="margin-top: px; margin-left: 5px;"><i class="fa fa-print"></i> Cetak Semua</a>
