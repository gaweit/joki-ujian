        ...
        <div class="row clearfix">
           ...
           <div class="col-sm-1">
            ...
            <div class="col-sm-4">
                 ...
                 <input type="text" name="kode"  class="form-control" placeholder="Kode Barang/Barcode"   required="" id="kode"  autocomplete="off">
...
<?php 
    ...
    if (isset($_POST['simpan'])) {
        ...
        $sql = $koneksi->query("insert into tb_pembelian2 (kode_pembelian, jumlah, harga,  total, kode_barang,  tanggal) values('$kode_pj', '$jumlah', '$harga_beli', '$total', '$barcode', '$tgl_jual')");
                        ...
                        <form method="POST">
                            <table class="table table-striped">
                                ...
                                <?php 
                                    ...
                                    $no = 1;
                                    $sql = $koneksi->query("select * from tb_pembelian2, tb_barang2 where tb_pembelian2.kode_barang=tb_barang2.kode_barang and kode_pembelian='$kd_pjl'");
                                 ...
                                 ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="return confirm('Yakin Akan Membatalkan Pembelian ini.?') "  href="?page=pembelian&aksi=hapus&id=<?php echo $data['id'];?>&kd_pb=<?php echo $data['kode_pembelian']; ?>&kode_barang=<?php echo $data['kode_barang']; ?>&jumlah=<?php echo $data['jumlah']; ?>" class= "btn btn-danger waves-effect"><i class="material-icons">clear </i> Cancel</a>
                                        </td>
                                    </tr>
                        ...
                        <table>
                            ...
                            <table>
                                    ...
                                    <?php 
                                        ...
                                        $sql = $koneksi->query("select * from tb_pembelian2 where kode_pembelian='$kd_pjl'");
                            ...
                            <table>
                                <tr>
                                    <td>harap cek retur</td>
                                </tr>
                            </table>
                        </div>
                        <div class="modal-footer">
                            <a href="page/pembelian/cetak.php?invoice=<?php echo $kd_pjl; ?>&kasir=<?php echo $data_u['nama']; ?>" target="blank" class="btn btn-link waves-effect"><i class="material-icons">print </i>Cetak</a>
