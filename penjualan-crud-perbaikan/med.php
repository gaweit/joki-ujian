...
<div class="w3-row w3-blue-grey w3-padding">
  <div class="w3-half" style="margin:15px 0 2px 0;"><b class='w3-text-shadow w3-text-bold w3-opacity'>PPC CILACAP</b><br><i style="font-size:12px;">    <div class="w3-half" style="margin:15px 0 2px 0;"><b class='w3-text-shadow w3-text-bold w3-opacity'></b><br><i style="font-size:12px;">Jl. Tlk. Penyu Jl. Lingkar Timur No.2, Kemiren, Tegalkamulyan, Kec. Cilacap Sel., Kabupaten Cilacap, Jawa Tengah 53211</i></div>
</i></div>
  ...
  <!--onmouseout="w3_hide_scroll()" onmouseover="w3_show_scroll()"-->
    <?php
        ...
        while ($mn = mysql_fetch_assoc($sql_menu)) {
            echo"<button onclick=\"myFunction('".$mn['id_menu']."')\" class=\"w3-padding-hor-16 w3-btn-block w3-left-align w3-green\"> $mn[nama_menu] <i class=\"fa fa-caret-down\"></i></button>
    ...
    <div style="margin-left:250px;">
        ...
        <ul class="w3-navbar w3-light-grey w3-small w3-card-4">
          ...
          <li><a class="w3-hover-black w3-padding-10" href="med.php?mod=penjualan"><i class="fa fa-shopping-cart"></i> Transaksi Penjualan</a></li>
          <li><a class="w3-hover-black w3-padding-10" href="med.php?mod=pembelian&act=form"><i class="fa fa-shopping-cart"></i> Transaksi Pembelian</a></li>
          <li><a class="w3-hover-black w3-padding-10" href="med.php?mod=user"><i class="fa fa-group"></i> Pengaturan User</a></li>
