...
?>
<h4 class="w3-text-blue" style="padding-bottom:0;margin-bottom:0;"><b>PPC CILACAP</b></h4>
<div class="w3-row">
	<div class="w3-col s6 w3-tiny">Jl. Tlk. Penyu Jl. Lingkar Timur No.2, Kemiren, Tegalkamulyan, Kec. Cilacap Sel., Kabupaten Cilacap, Jawa Tengah 53211<br>
		 (0282) 532682
	</div>
...
<div class="w3-row-padding w3-tiny">
	...
	<div class="w3-col s4">
		<div class="w3-border w3-padding" style="font-size:8px;text-align:justify;">
				* Terima kasih telah membeli di PPC!kami sangat bersemangat mengemas pesananmu.Jangan lupa berbelanja labih banyak lagi,ya!<br>
	...
	<div class="w3-col s4 w3-center">
		<p>Cilacap, <?php echo date('d-m-Y', strtotime($tra['tgl_transaksi'])); ?>
		<br>Hormat Kami,</p>
		<br>
		<br>
