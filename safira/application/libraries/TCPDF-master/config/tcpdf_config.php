 ...
 */
define('PDF_HEADER_LOGO', 'banjar.png');

/**
 * Header logo image width in user units.
 */
define('PDF_HEADER_LOGO_WIDTH', 98);
 ...
 */
define('PDF_HEADER_STRING', "             PT. AIR MINUM INTAN BANJAR (PERSERODA)
                   Jl. Pangeran Hidayatullah No. 24 Banjarbaru
                   (0511)4772061 / 4762004 / 0852 66 000 111
                                       contact@pdamintanbanjar.co.id
                                             www.pdamintanbanjar.co.id");
