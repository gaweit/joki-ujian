        ...
        <div class="table-responsive">
            <table class="table table-striped ">
                ...
                <tbody>
                    ...
                    $no = 1;
                    $total_bayar = 0;
                    $sql = $koneksi->query("select a.*, b.nama_barang , b.satuan, a.jumlah,b.harga_jual from tb_penjualan_detail a JOIN tb_barang b ON a.kode_barcode = b.kode_barcode WHERE a.kode_penjualan = '" . $_GET['kodepj'] . "'");
