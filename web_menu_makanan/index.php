    ...
    <div class="container-input">
        <div class="form-container">
            ...
            <div>
                    ...
                    <input type="text" id="food_code" name="food_code" required>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="food_photo_url" name="food_photo_url" required>
                </div><button type="submit" >Add to Order</button>
         </form>
         <br>
         <div align="center">
<a href="order.php"><button type="">Page Order -></button></a> 
     </div>
        </div>
